...
public class PictureDataInDetail {
    ...
    private String maketime;  private ShareListInPictureData share_list;
    private int praisenum;
    private int sharenum;
    private int commentnum;

    public ShareListInPictureData getShare_list() {
        return share_list;
    }

    public void setShare_list(ShareListInPictureData share_list) {
